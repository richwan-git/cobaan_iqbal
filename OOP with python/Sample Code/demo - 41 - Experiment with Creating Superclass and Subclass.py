#==================================================================
# Let's Experiment with Creating a Superclass and a Subclass
# Demo/Practice - 41
...
#-----------------------------------------------------
print("The name of the student is " + str(julius.getFullName()))
print("The name of the teacher is " + str(teacherSharon.getFullName()))
print("============")
...
print("The updated first name of the student is " + str(julius.getFullName()))
print("============")
